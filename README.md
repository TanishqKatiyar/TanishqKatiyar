...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=ts,js,python,go,react,nextjs,tailwind,nodejs,express,nestjs,mongodb,postgres,redis,docker,git,linux,aws&perline=9" />
  </a>
</p>
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=pytorch,tensorflow,bash,docker,github,vercel,figma,postman&perline=9" />
  </a>
</p>
...
|:---|:---|:---|
| 🤖 **[Interview Agent](https://github.com/TanishqKatiyar/Interview_agent-)** | Enterprise AI screening platform with real-time WebRTC audio & dynamic LLM routing. | Next.js, WebRTC, OpenAI |
| 📋 **[Tasklane](https://github.com/TanishqKatiyar/tasklane)** | High-performance real-time collaborative workspace with WebSocket sync. | NestJS, React, Redis |
| 🛡️ **[Anti-Fraud Delivery](https://github.com/TanishqKatiyar/Anti-fraud-delivery-system)** | ML-driven delivery verification with anomaly detection and geospatial analysis. | Python, FastAPI, ML |
| 💰 **[Smart Expense Tracker](https://github.com/TanishqKatiyar/Smart-Expense-Tracker)** | Voice-first expense tracking with predictive analytics and smart categorization. | React, Node.js, AI |
